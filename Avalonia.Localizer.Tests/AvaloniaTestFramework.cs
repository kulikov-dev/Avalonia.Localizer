...
{
    /// <summary>
    /// Framework to connect XUnit with Avalonia
    /// </summary>
    ...
    public class AvaloniaUiTestFramework : XunitTestFramework
    {
        ...
        protected override ITestFrameworkExecutor CreateExecutor(AssemblyName assemblyName) => new Executor(assemblyName, SourceInformationProvider, DiagnosticMessageSink);
        ...
        private class Executor : XunitTestFrameworkExecutor
        {
                ...
                ITestFrameworkExecutionOptions executionOptions)
            {
                ...
                using var assemblyRunner = new Runner(TestAssembly, testCases, DiagnosticMessageSink, executionMessageSink, executionOptions);
